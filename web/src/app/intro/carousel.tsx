...
function Carousel() {
  ...
  return (
    ...
    >
      <Slider {...settings}>
        <TbBrandReact
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-cyan-300"
          title="React"
          aria-label="React" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandNextjs
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-white"
          title="Next.js"
          aria-label="Next.js" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandTailwind
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-sky-300"
          title="Tailwind CSS"
          aria-label="Tailwind CSS" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandTypescript
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-blue-500"
          title="Typescript"
          aria-label="Typescript" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandJavascript
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-yellow-300"
          title="Javascript"
          aria-label="Javascript" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandCss3
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-purple-400"
          title="CSS3"
          aria-label="CSS3" // Acessibilidade: Aria-label diretamente no ícone
          aria-hidden="true"
        />
        <TbBrandHtml5
          className="transition-all duration-500 hover:scale-90 hover:rotate-360 text-orange-400"
          title="HTML5"
